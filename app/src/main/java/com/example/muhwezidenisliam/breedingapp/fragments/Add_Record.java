...
public class Add_Record extends Fragment {
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        persons.add(new Person("Add Breeding Records", R.drawable.ic_add_black_36dp));
        persons.add(new Person("Add Cattle Records", R.drawable.ic_add_black_36dp));
        persons.add(new Person("Add Heifer Records", R.drawable.ic_add_black_36dp));
        persons.add(new Person("Add Milk Records", R.drawable.ic_add_black_36dp));
