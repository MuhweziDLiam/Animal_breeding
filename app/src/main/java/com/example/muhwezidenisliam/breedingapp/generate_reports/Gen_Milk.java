...
public class Gen_Milk extends AppCompatActivity{
...
//                "Sep", "Oct", "Nov", "Dec",};
        ...
        private void generateColumnData() {
            ...
            int numSubcolumns = 1;
            int numColumns =loginDataBaseAdapter.getAggMilk().size();
            ...
            for (int i = 0; i < numColumns; ++i) {
                ...
                for (int j = 0; j < numSubcolumns; ++j) {
                    values.add(new SubcolumnValue(Float.parseFloat(loginDataBaseAdapter.getAggMilk().get(i).get("c")) * 1f, ChartUtils.pickColor()));
                }

                axisValues.add(new AxisValue(i).setLabel(loginDataBaseAdapter.getAggMilk().get(i).get("b")));
